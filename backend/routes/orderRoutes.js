...
router.get('/analytics/orders-count-by-status', orderController.getOrdersCountByStatus);
...
router.get('/analytics/most-reviewed-products', orderController.getMostReviewedProducts);
router.get('/analytics/customer-lifetime-value', orderController.getCustomerLifetimeValue);
router.get('/analytics/avg-time-between-orders', orderController.getAvgTimeBetweenOrders);
router.get('/analytics/product-return-rate', orderController.getProductReturnRate);
